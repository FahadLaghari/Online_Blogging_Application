							        ...
							        <?php if (isset($_REQUEST['msg'])) {
							          ...
							          <form action="register_process.php" method="POST" enctype="multipart/form-data">
							            ...
							            <!-- Image -->
							              ...
							              <div class="form-outline mb-4">
							              <input type="file" id="pprofile" name="profile"class="form-control" required />
							               <span>*</span>
							            ...
							            <div class="form-outline mb-4">
							              ...
							              <!-- Password End -->
							          	   ...
							          	   <div class="form-outline mb-4">
							             	<select name="role_type" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
							             		<option value="1"> Admin</option>
							             		<option value="2"> user</option>
							             	</select>
							              <label class="form-label" for="form3Example4">Role_type</label>
							              <!-- Password End -->
							              <!-- Address -->
							          </div>
							              <!-- Address -->
