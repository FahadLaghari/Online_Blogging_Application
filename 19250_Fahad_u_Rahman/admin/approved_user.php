    ...
    <section class="text-center">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <?php
          $query = "SELECT * FROM user WHERE is_approved='Approved'";
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-success">
                          <a style="color: #F59640" href="approved_user_process.php?id=<?php echo $data['user_id']; ?>&action=view">view</a>
                        </button>
                      </td>
                      <td>
                        <button type="button" class="btn btn-success">
                          <a style="color: #F59640" href="approved_user_process.php?id=<?php echo $data['user_id']; ?>&action=edit">Edit</a>
                        </button>
                      </td>
                      <td>
                        <button type="button" class="btn btn-success">
                          <a style="color: #F59640" href="approved_user_process.php?id=<?php echo $data['user_id']; ?>&active=Active">Active</a>
                        </button>
                      </td>
                      <td>
                        <button type="button" class="btn btn-danger">
                          <a style="color: #F59640" href="approved_user_process.php?id=<?php echo $data['user_id']; ?>&InActive=InActive">InActive</a>
                        </button>
                      </td>
                    </tr>
                  <?php
