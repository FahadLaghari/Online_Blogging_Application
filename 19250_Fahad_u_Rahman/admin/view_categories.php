...
<?php
	  if (isset($_REQUEST['action'])=='Active') {
                          $query="UPDATE category
							SET category_status ='Active',updated_at='".$date."'
              ...
              $query="UPDATE category
							SET category_status ='InActive',updated_at='".$date."'
							WHERE category_id  ='".$_REQUEST['id']."'";
                        	$result=mysqli_query($connection,$query);
		                      if ($result) {
		                       ?>
...
if ($result->num_rows > 0) {
 ...
 <div class="table-responsive">
  <table border="1" align="center" class="table table-hover" class="table-responsive">
    <tr>
    ...
    while ($data = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td colspan="3">
          ...
          href="view_categories.php?id=<?php echo $data['category_id'];  ?> &action=Active">Active</a>
          </button>
        </td>
          <td>
              <button type="button" class="btn btn-danger">
            <a  style="color:#F59640 "href="view_categories.php?id=<?php echo $data['category_id']; ?> &Action=inactive">InActive</a>
            </button>
          </td>
          <td>
              <button type="button" class="btn btn-danger">
            <a  style="color:#F59640 "href="view_categories.php?id=<?php echo $data['category_id'];  ?> &action=Delete">Delete</a>
            </button>
          </td>
           <td>
              <button type="button" class="btn btn-info">
            <a  style="color:#F59640 "href="edit_category.php?id=<?php echo $data['category_id'];  ?> &action=edit">Edit</a>
            </button>
          </td>
