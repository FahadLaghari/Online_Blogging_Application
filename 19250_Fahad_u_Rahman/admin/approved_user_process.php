              ...
              if ($result)
               {
                  ...
                  $mail->msgHTML("Dear User Your Account is Activated");
                  if (!$mail->send()) {
                ...
                header("location:approved_user.php?msg=Activated Sucessfully");
                }      
      }
              ...
              if ($result)
               {
                 $mail->addAddress($inactive_user['email']);
                  ...
                  $mail->msgHTML("Dear User Your Account is deactivated  due to some issues");
                  if (!$mail->send()) {
                      echo 'Mailer Error: ' . $mail->ErrorInfo;
                  } else {
                      echo 'Message sent!';
                  }
                header("location:approved_user.php?msg=INActivated ");
                }      
      }
if (isset($_REQUEST['action'])=='view') {
 
  $query=" SELECT * FROM USER WHERE user_id='".$_REQUEST['id']."'; ";
  $result=mysqli_query($connection,$query);
           ...
           <div class="container-fluid">
              ...
              <section class="text-center">
                <div class="card mx-4 mx-md-5 shadow-5-strong" style="
                      background: hsla(0, 0%, 100%, 0.8);height: 800px;margin-top:70px;
    
                      ">
                  <div class="card-body py-5 px-md-5">
                        <div style="margin-right: ">
                          <img src="../<?php
                                echo $data['user_image'];?>" height="200px" width="200px">
                        </div>
                    <div class="row d-flex justify-content-center">
                      <div class="col-lg-8">
                        ...
                        <form  action="#" method="POST"enctype="multipart/form-data">
                          <div class="col-md-6 mb-4" style="margin-left: 30%">
                                <label class="form-label" for="form3Example2">user_image</label>
                                <span>*</span>
                              <div class="form-outline">
                                <input type="file" id="last_name"name="user_image" class="form-control"  />
                              </div>
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                ...
                                echo $data['first_name'];?>" class="form-control" required />
                                <span>*</span>
                            ...
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                ...
                                echo $data['last_name'];?>"class="form-control" />
                                <span>*</span>
                          ...
                          <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                ...
                                echo $data['address'];?>" class="form-control"  />
                                <span>*</span>
                            ...
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                ...
                                echo $data['gender'];?>"class="form-control"/>
                                <span>*</span>
                            ...
                            <div class="col-md-6 mb-4">
                              <div class="form-outline">
                                ...
                                echo $data['date_of_birth'];?>" class="form-control" />
                                <span>*</span>
   ...
   /*  print_r($_POST);
     die();*/
      extract($_POST);
       ...
       $path = $user_image['user_image'];
  }
  else{
        $directory="images";
        $image_name= rand().$_FILES['user_image']['name'];
...
$result=mysqli_query($connection,$query);
 if ($result) {
   ...
   <script>
    ...
    window.location.href="approved_user_process.php?id=<?php echo $_REQUEST['id'] ?>&action=view";
</script>
   <?php
