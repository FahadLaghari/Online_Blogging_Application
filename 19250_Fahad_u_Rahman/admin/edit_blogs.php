...
date_default_timezone_set("Asia/Karachi");  
  ...
  if (isset($_REQUEST['action'])=='edit') {
            ...
            $query = "SELECT * FROM `blog`  WHERE blog_id='".$_REQUEST['id']."' ";
           ...
           <div class="container-fluid">
              ...
              <section class="text-center">
                <div class="card mx-4 mx-md-5 shadow-5-strong" style="
                      background: hsla(0, 0%, 100%, 0.8);height: 620px;margin-top:100px;
                  ...
                  <div class="card-body py-5 px-md-5">
                    <div class="row d-flex justify-content-center">
                      <div class="col-lg-8">
                                  <div>
                                    <img src="../<?php echo $data['blog_background_image']?>" height="200px">
                                  </div>
                        ...
                        <form action="#" method="POST"  class="mt-5" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            <div class="col-md-6 mb-4">
                                <label class="form-label" for="form3Example1">Blog_title</label>
                                <span>*</span>
                              <div class="form-outline">
                                <input type="text" id="first_name" name="blog_title" value="<?php echo $data['blog_title'];?>" class="form-control" required />
                              </div>
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label" for="form3Example2">Background Image</label>
                                <span>*</span>
                              <div class="form-outline">
                                <input type="file" id="last_name"name="background_image"value="<?php
                                echo $data['blog_background_image']?>"class="form-control"  />
                              </div>
                                       
                            </div>
                            <div class="col-md-6 mb-4">
                                <label class="form-label" for="form3Example2">Blog Status</label>
                                <span>*</span>
                              <div class="form-outline">
                             	<select name="blog_status"class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" required>
...
if(isset($_POST['update'])){
  ...
  extract($_POST);
   ...
   if ($_FILES['background_image']['name']=="") {
    $path = $background_image['background_image'];
  }
  else{
        $directory="images";
        $image_name= rand().$_FILES['background_image']['name'];
        $image_path= $_FILES['background_image']['tmp_name'];
  ...
  $query=" UPDATE blog
SET blog_title ='".$blog_title."', blog_background_image='".$path."',updated_at=NOW()
