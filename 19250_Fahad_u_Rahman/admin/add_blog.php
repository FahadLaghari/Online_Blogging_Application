							  ...
							  <div class="card mx-4 mx-md-5 shadow-5-strong" style="
							      ...
							      <div class="row d-flex justify-content-center">
								        <div class="col-lg-8 mt-5" >
								            <h2 class="fw-bold mb-5">Create Page/Blog</h2>
								            <p>
								           ...
								           <form action="blog_process.php" method="POST" enctype="Multipart/form-data">
										            <div class="form-outline mb-4">
										              <label class="form-label" for="form3Example3">Page/Blog Title</label>
										              <input type="text" id="blog_title" name="blog_title"class="form-control" required />
										            </div>

										            <div class="form-outline mb-4">
										              <label class="form-label" for="form3Example3">Post Per Page</label>
										              <input type="number" min="1" name="per_page" class="form-control required">
										            </div>
										           
										              <div class="form-outline mb-4">
											              <label class="form-label" for="form3Example3">Image</label>
											              <input type="file" id="form3Example3"name="featured_image" class="form-control"required />
										             </div>
